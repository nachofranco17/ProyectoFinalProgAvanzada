...
_lr_signature = 'statementleftANDORnonassocBETWEENIGUALMAYOR_QUEMENOR_QUEMAYOR_IGUALMENOR_IGUALDIFERENTEACTUALIZA ADD_COLUMN AGREGA_LA_COLUMNA AGRUPANDO_POR ALTER_TABLE AND ASTERISCO AVG BETWEEN BORRA_DE_LA CAMBIA_LA_TABLA CAST CLAVE_PRIMA CLAVE_REFERENTE COMA COMO_MUCHO CONTANDO COUNT CREATE_TABLE CREA_LA_TABLA DEFAULT DELETE_FROM DE_LA_TABLA DIFERENTE DISTINCT DONDE DROP_COLUMN DROP_TABLE ELIMINA_LA_COLUMNA EN ENTRE EN_ESTO ES_NULO EXISTE EXISTS FLOAT FOREIGN_KEY FROM GROUP_BY HAVING ID IGUAL IN INSERT_INTO INT IS_NULL JOIN LIKE LIMIT LOS_DISTINTOS LOS_VALORES MAX MAYOR_IGUAL MAYOR_QUE MENOR_IGUAL MENOR_QUE METE_EN MEZCLANDO MIN NOT_NULL NO_NULO NUM ON OR ORDENA_POR ORDER_BY PARECIDO_A PARENDER PARENIZQ POR_DEFECTO PRIMARY_KEY PUNTO PUNTO_Y_COMA SELECT SET SETEA STRING SUM TIRA_LA_TABLA TODO TRAEME TRANSFORMA_A UNICO UNIQUE UPDATE VALUES VARCHAR WHERE WHERE_DEL_GROUP_BY Ystatement : select_statement\n                 | insert_statement\n                 | update_statement\n                 | delete_statement\n                 | alter_table_statementselect_statement : SELECT opt_distinct select_list FROM table_list opt_join_clause opt_where_clause opt_group_by_clause opt_having_clause opt_order_by_clause PUNTO_Y_COMAopt_order_by_clause : ORDER_BY column_list\n                           | emptyopt_distinct : DISTINCT\n                    | emptyselect_list : ASTERISCO\n                   | select_itemsselect_items : select_items COMA select_item\n                    | select_itemselect_item : DISTINCT identifier\n                   | identifier\n                   | function_callfunction_call : COUNT PARENIZQ operand PARENDER\n                     | SUM PARENIZQ operand PARENDER\n                     | AVG PARENIZQ operand PARENDER\n                     | MIN PARENIZQ operand PARENDER\n                     | MAX PARENIZQ operand PARENDERcolumn_list : identifier\n                   | identifier COMA column_listtable_list : identifier\n                  | identifier COMA table_listopt_join_clause : JOIN identifier ON condition\n                       | emptyopt_where_clause : WHERE condition\n                        | emptyopt_group_by_clause : GROUP_BY column_list\n                           | emptyopt_having_clause : HAVING condition\n                         | emptycondition : expression\n                 | condition AND condition\n                 | condition OR conditionoperand : value\n               | aggregate_functionvalue : NUM\n             | STRING\n             | identifier\n             | ASTERISCOexpression : operand comparador operand\n                  | operand BETWEEN operand AND operandaggregate_function : COUNT PARENIZQ operand PARENDER\n                          | SUM PARENIZQ operand PARENDER\n                          | AVG PARENIZQ operand PARENDER\n                          | MIN PARENIZQ operand PARENDER\n                          | MAX PARENIZQ operand PARENDERcomparador : IGUAL\n                  | MAYOR_QUE\n                  | MENOR_QUE\n                  | MAYOR_IGUAL\n                  | MENOR_IGUAL\n                  | DIFERENTEinsert_statement : INSERT_INTO identifier PARENIZQ column_list PARENDER VALUES PARENIZQ value_list PARENDER PUNTO_Y_COMAvalue_list : value\n                  | value COMA value_listupdate_statement : UPDATE identifier SET assignment_list opt_where_clause PUNTO_Y_COMAassignment_list : assignment\n                       | assignment COMA assignment_listassignment : identifier IGUAL valuedelete_statement : DELETE_FROM identifier opt_where_clause PUNTO_Y_COMAalter_table_statement : ALTER_TABLE identifier ADD_COLUMN column_definition PUNTO_Y_COMA\n                             | ALTER_TABLE identifier DROP_COLUMN identifier PUNTO_Y_COMAcreate_table_statement : CREATE_TABLE identifier PARENIZQ column_definition_list PARENDER PUNTO_Y_COMAcolumn_definition_list : column_definition\n                              | column_definition COMA column_definition_listcolumn_definition : identifier data_type column_constraintsdata_type : VARCHAR PARENIZQ NUM PARENDER\n                 | INTcolumn_constraints : constraint\n                          | column_constraints constraintconstraint : NOT_NULL\n                  | UNIQUE\n                  | PRIMARY_KEY\n                  | FOREIGN_KEYidentifier : ID\n                  | ID PUNTO IDempty :'
    
_lr_action_items = {'SELECT':([0,],[7,]),'INSERT_INTO':([0,],[8,]),'UPDATE':([0,],[9,]),'DELETE_FROM':([0,],[10,]),'ALTER_TABLE':([0,],[11,]),'$end':([1,2,3,4,5,6,54,103,104,117,166,168,],[0,-1,-2,-3,-4,-5,-64,-65,-66,-60,-57,-6,]),'DISTINCT':([7,12,13,14,41,],[13,24,-9,-10,24,]),'ASTERISCO':([7,12,13,14,36,43,44,45,46,47,82,85,86,87,88,89,90,91,92,93,94,95,96,97,98,99,138,139,150,156,161,],[-81,21,-9,-10,63,63,63,63,63,63,63,63,63,63,63,-51,-52,-53,-54,-55,-56,63,63,63,63,63,63,63,63,63,63,]),'ID':([7,8,9,10,11,12,13,14,24,32,33,34,36,38,39,40,41,43,44,45,46,47,80,82,84,85,86,87,88,89,90,91,92,93,94,95,96,97,98,99,106,108,138,139,148,150,156,161,163,],[-81,16,16,16,16,16,-9,-10,16,16,50,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,-51,-52,-53,-54,-55,-56,16,16,16,16,16,16,16,16,16,16,16,16,16,16,]),'COUNT':([7,12,13,14,36,41,43,44,45,46,47,85,86,87,88,89,90,91,92,93,94,95,96,97,98,99,139,150,156,],[-81,27,-9,-10,64,27,64,64,64,64,64,64,64,64,64,-51,-52,-53,-54,-55,-56,64,64,64,64,64,64,64,64,]),'SUM':([7,12,13,14,36,41,43,44,45,46,47,85,86,87,88,89,90,91,92,93,94,95,96,97,98,99,139,150,156,],[-81,28,-9,-10,65,28,65,65,65,65,65,65,65,65,65,-51,-52,-53,-54,-55,-56,65,65,65,65,65,65,65,65,]),'AVG':([7,12,13,14,36,41,43,44,45,46,47,85,86,87,88,89,90,91,92,93,94,95,96,97,98,99,139,150,156,],[-81,29,-9,-10,66,29,66,66,66,66,66,66,66,66,66,-51,-52,-53,-54,-55,-56,66,66,66,66,66,66,66,66,]),'MIN':([7,12,13,14,36,41,43,44,45,46,47,85,86,87,88,89,90,91,92,93,94,95,96,97,98,99,139,150,156,],[-81,30,-9,-10,67,30,67,67,67,67,67,67,67,67,67,-51,-52,-53,-54,-55,-56,67,67,67,67,67,67,67,67,]),'MAX':([7,12,13,14,36,41,43,44,45,46,47,85,86,87,88,89,90,91,92,93,94,95,96,97,98,99,139,150,156,],[-81,31,-9,-10,68,31,68,68,68,68,68,68,68,68,68,-51,-52,-53,-54,-55,-56,68,68,68,68,68,68,68,68,]),'PARENIZQ':([15,16,27,28,29,30,31,50,64,65,66,67,68,101,115,],[32,-79,43,44,45,46,47,-80,95,96,97,98,99,134,138,]),'SET':([16,17,50,],[-79,34,-80,]),'WHERE':([16,18,50,52,53,56,58,59,60,61,62,63,72,73,105,107,116,118,119,120,121,137,140,141,142,143,144,153,159,],[-79,36,-80,36,-61,-35,-38,-39,-40,-41,-42,-43,-81,-25,36,-28,-63,-62,-36,-37,-44,-26,-46,-47,-48,-49,-50,-45,-27,]),'PUNTO_Y_COMA':([16,18,35,37,48,50,52,53,55,56,
45,-31,-27,]),'ORDER_BY':([16,37,48,50,55,56,58,59,60,61,62,63,72,73,105,107,114,119,120,121,135,137,140,141,142,143,144,147,149,153,155,157,158,159,165,],[-79,-30,-23,-80,-29,-35,-38,-39,-40,-41,-42,-43,-81,-25,-81,-28,-24,-36,-37,-44,-81,-26,-46,-47,-48,-49,-50,-81,-32,-45,163,-34,-31,-27,-33,]),'AND':([16,50,55,56,58,59,60,61,62,63,119,120,121,122,140,141,142,143,144,153,159,165,],[-79,-80,85,-35,-38,-39,-40,-41,-42,-43,-36,-37,-44,139,-46,-47,-48,-49,-50,-45,85,85,]),'OR':([16,50,55,56,58,59,60,61,62,63,119,120,121,140,141,142,143,144,153,159,165,],[-79,-80,86,-35,-38,-39,-40,-41,-42,-43,-36,-37,-44,-46,-47,-48,-49,-50,-45,86,86,]),'ON':([16,50,136,],[-79,-80,150,]),'PUNTO':([16,],[33,]),'NUM':([36,43,44,45,46,47,82,85,86,87,88,89,90,91,92,93,94,95,96,97,98,99,134,138,139,150,156,161,],[60,60,60,60,60,60,60,60,60,60,60,-51,-52,-53,-54,-55,-56,60,60,60,60,60,146,60,60,60,60,60,]),'STRING':([36,43,44,45,46,47,82,85,86,87,88,89,90,91,92,93,94,95,96,97,98,99,138,139,150,156,161,],[61,61,61,61,61,61,61,61,61,61,61,-51,-52,-53,-54,-55,-56,61,61,61,61,61,61,61,61,61,61,]),'VALUES':([81,],[115,]),'NOT_NULL':([100,102,128,129,130,131,132,133,145,154,],[130,-72,130,-73,-75,-76,-77,-78,-74,-71,]),'UNIQUE':([100,102,128,129,130,131,132,133,145,154,],[131,-72,131,-73,-75,-76,-77,-78,-74,-71,]),'PRIMARY_KEY':([100,102,128,129,130,131,132,133,145,154,],[132,-72,132,-73,-75,-76,-77,-78,-74,-71,]),'FOREIGN_KEY':([100,102,128,129,130,131,132,133,145,154,],[133,-72,133,-73,-75,-76,-77,-78,-74,-71,]),}
...
_lr_productions = [
  ...
  ('create_table_statement -> CREATE_TABLE identifier PARENIZQ column_definition_list PARENDER PUNTO_Y_COMA','create_table_statement',6,'p_create_table_statement','ParserSQL.py',199),
  ('column_definition_list -> column_definition','column_definition_list',1,'p_column_definition_list','ParserSQL.py',203),
  ('column_definition_list -> column_definition COMA column_definition_list','column_definition_list',3,'p_column_definition_list','ParserSQL.py',204),
  ('column_definition -> identifier data_type column_constraints','column_definition',3,'p_column_definition','ParserSQL.py',211),
  ('data_type -> VARCHAR PARENIZQ NUM PARENDER','data_type',4,'p_data_type','ParserSQL.py',215),
  ('data_type -> INT','data_type',1,'p_data_type','ParserSQL.py',216),
  ('column_constraints -> constraint','column_constraints',1,'p_column_constraints','ParserSQL.py',223),
  ('column_constraints -> column_constraints constraint','column_constraints',2,'p_column_constraints','ParserSQL.py',224),
  ('constraint -> NOT_NULL','constraint',1,'p_constraint','ParserSQL.py',231),
  ('constraint -> UNIQUE','constraint',1,'p_constraint','ParserSQL.py',232),
  ('constraint -> PRIMARY_KEY','constraint',1,'p_constraint','ParserSQL.py',233),
  ('constraint -> FOREIGN_KEY','constraint',1,'p_constraint','ParserSQL.py',234),
  ('identifier -> ID','identifier',1,'p_identifier','ParserSQL.py',238),
  ('identifier -> ID PUNTO ID','identifier',3,'p_identifier','ParserSQL.py',239),
  ('empty -> <empty>','empty',0,'p_empty','ParserSQL.py',246),
]
